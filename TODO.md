...
- [ ] **[P0] Real tokenizer per provider.**
...
- [ ] **[P0] Output truncation with `peek` handle.**
...
- [ ] **[P1] Pre-turn vs mid-turn compaction split.**
...
- [ ] **[P1] Per-section budget telemetry.**
...
- [ ] **[P1] Prompt-caching markers in provider request builders.**
...
- [ ] **[P1] Contextual messages distinct from user messages.**
...
- [ ] **[P0] `Session.fork(at_offset=None)`.**
...
- [ ] **[P0] Composable `Session.create()` overrides.**
...
- [ ] **[P1] Parallel tool execution within a turn.**
...
- [ ] **[P1] Tool result post-processors.**
...
- [ ] **[P1] Optional tool output schema.**
...
- [ ] **[P0] LSP-backed `goto_def` / `find_refs` / `hover`.**
...
- [ ] **[P2] `git_status` / `git_diff` as first-class tools.**
...
- [ ] **[P0] `harness.resume_session(stream_id)` end-to-end.**
...
- [ ] **[P0] `RunResult.total_usage` + `RunResult.cost_usd`.**
...
- [ ] **[P0] Session tree picker (Ctrl+S or `/sessions`).**
...
- [ ] **[P1] Structured logging with `contextvars`.**
...
- [ ] **[P1] OpenTelemetry hooks behind `taui[otel]` extra.**
...
- [ ] **[P0] Typed provider error taxonomy.**
...
- [ ] **[P0] Auto-recovery on `ContextOverflowError`.**
...
- [ ] **[P2] HTTP/SSE transport** in addition to stdio.

- [ ] **[P2] Per-server prefix override.**
...
- [ ] **[P1] Diff viewer for every write/edit.**
...
- [ ] **[P0] Extension can register a provider.**
...
- [ ] **[P1] Self-edit playbooks for the new surfaces.**
...
- [ ] **[P0] Property tests for `compact_messages` (all strategies).**
...
- [ ] **[P0] File-state tracker test matrix.**
