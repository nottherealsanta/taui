...
- **Multi-Process Runtime** — split agent execution and web transport into separate processes for crash isolation, independent scaling, or stricter security boundaries.
