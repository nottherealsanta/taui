export function tangleRefToFilePath(tangleRef: string): string {
  return tangleRef.split('#')[0] ?? tangleRef
}
...
export function deriveTangleTitle(
  filePath: string,
  content: string,
...
export const specRefToFilePath = tangleRefToFilePath
export const deriveSpecTitle = deriveTangleTitle
